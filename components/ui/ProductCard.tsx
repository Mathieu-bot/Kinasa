...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <motion.div
      className="product-card relative bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100"
    ...
    >
      ...
      <div className="p-4">
        ...
        <h3 className="font-medium text-lg mb-1 text-gray-800">{name}</h3>
