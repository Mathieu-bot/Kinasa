...
const ACTIVITY_DATA = [
  ...
  },
  {
    ...
    title: "New Order",
    description:
      "Bean Lovers confirmed an order of 800kg of Premium Arabica Coffee",
    time: "3 days ago",
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="lg:col-span-3 border-0 overflow-hidden shadow-md hover:shadow-lg relative before:absolute before:inset-0 before:bg-gradient-to-br before:from-amber-300/20 before:via-teal-400/10 before:to-amber-200/20 before:z-0 transition-all duration-300">
          ...
          <CardHeader>
            ...
            <CardDescription>
              Current status of your certifications
            </CardDescription>
          </CardHeader>
              ...
              <div key={cert.id} className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="mt-1 h-2 w-full rounded-full bg-gray-100">
                    <div
                      className={`h-2 rounded-full ${cert.progressColor}`}
          ...
          <CardFooter>
            <Button
              variant="outline"
              className="w-full bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white border-none shadow-sm hover:shadow-md cursor-pointer transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
            >
        ...
        <Card className="lg:col-span-4 border-0 overflow-hidden shadow-md hover:shadow-lg relative before:absolute before:inset-0 before:bg-gradient-to-br before:from-amber-600/20 before:via-teal-400/10 before:to-amber-500/20 before:z-0 transition-all duration-300">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-1 flex justify-between">
                      <span className="text-sm">
                        Monthly Sales: {product.quantity}
                      </span>
          ...
          <CardFooter>
            <Button
              variant="outline"
              className="w-full bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-white border-none shadow-sm hover:shadow-md cursor-pointer transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
            >
