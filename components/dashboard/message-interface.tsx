...
export const MessageInterface = ({ contacts, userType }: MessageInterfaceProps) => {
  ...
  const loadMessages = (contactId: string) => {
    const simulatedMessages: Message[] = [
      ...
      },
      {
        id: '2',
        sender: 'user',
        content: 'Thanks for reaching out! Which variety are you interested in?',
        timestamp: '10:32 AM',
        read: true
      },
      {
        id: '3',
        sender: 'contact',
        content: 'I\'m looking for premium Arabica beans. Do you have any available from the highlands?',
        timestamp: '10:35 AM',
        read: true
      },
      {
        id: '4',
        sender: 'user',
        content: 'Yes, we have Antananarivo Premium Coffee from the highlands. It has exceptional quality with citrus notes.',
        timestamp: '10:38 AM',
        read: true
      },
      {
        id: '5',
        sender: 'contact',
        content: 'That sounds perfect! What quantity can you provide and what\'s your price per kg?',
        timestamp: '10:40 AM',
        read: true
      },
      {
        id: '6',
        sender: 'user',
        content: 'We currently have 2,500 kg available at €4.50 per kg. This batch is Fair Trade and Organic certified.',
        timestamp: '10:45 AM',
        read: true
      },
      {
        id: '7',
        sender: 'contact',
        content: 'Excellent. Could you send me a sample and the certification documents?',
        timestamp: '10:48 AM',
        read: true
      }
    ]
      ...
      simulatedMessages.push(
        {
          id: '8',
          sender: 'contact',
          content: 'Also, I would like to know more about your sustainable farming practices. Do you have documentation on that?',
          timestamp: '11:05 AM',
          read: false,
          isNew: true
        },
        {
          id: '9',
          sender: 'contact',
          content: 'And what about shipping options? Can we arrange for express delivery?',
          timestamp: '11:07 AM',
          read: false,
          isNew: true
        }
              ...
              >
                <div className="relative">
                  <Avatar>
                    ...
                    <AvatarFallback className={contact.role === 'buyer' ? "bg-amber-100 text-amber-800" : "bg-emerald-100 text-emerald-800"}>
        ...
        {activeContact ? (
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {activeContact.company && (
                    <p className="text-xs text-emerald-600">{activeContact.company}</p>
                  )}
                ...
                {messages.map((message) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <p className={`${!message.read && message.sender === 'contact' ? 'font-medium' : ''}`}>
                        {message.content}
                      </p>
                      <div
          ...
          <div className="flex h-full items-center justify-center">
            <div className="text-center">
              ...
              <h3 className="mt-4 text-lg font-semibold">No Contact Selected</h3>
