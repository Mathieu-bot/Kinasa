    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <Drawer>
        <DrawerTrigger asChild>
          ...
          >
            <Button 
              className="rounded-full h-16 w-16 bg-grocer-orange hover:bg-grocer-orange-dark shadow-lg"
            >
        ...
        <DrawerContent className="max-h-[85vh] overflow-auto">
          <div className="mx-auto w-full max-w-sm">
            <DrawerHeader>
              <DrawerTitle className="text-center text-xl font-bold">Your Cart</DrawerTitle>
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-grocer-green font-bold">${item.price.toFixed(2)}</p>
                        </div>
                      </div>
