...
const ACTIVITY_DATA = [
  {
    ...
    description:
      "Your order of Premium Arabica Coffee (800kg) has been confirmed",
    time: "2 hours ago",
  },
  {
    id: "2",
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="lg:col-span-4 border-0 overflow-hidden shadow-md hover:shadow-lg relative before:absolute before:inset-0 before:bg-gradient-to-br before:from-amber-300/20 before:via-teal-400/10 before:to-amber-200/20 before:z-0 transition-all duration-300">
          <CardHeader>
            ...
            <CardDescription>
              Based on your interests and previous purchases
            </CardDescription>
          </CardHeader>
          ...
          <CardFooter>
            <Button
              variant="outline"
              className="w-full bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white border-none shadow-sm hover:shadow-md cursor-pointer transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
            >
